...
accounts_urlpatterns = patterns('',
    ...
    url(r'^devlist/$', v.accounts_lists, {'acc_list': 'devlist'}, name="active_developers"),
    url(r'^former-devlist/$', v.accounts_lists, {'acc_list': 'former-devlist'}, name="former_developers"),
    url(r'^foundation-members/$', v.accounts_lists, {'acc_list': 'foundation-members'}, name="foundation_members"),
